...
@Module({
  imports: [
    ...
    MongooseModule.forRoot(process.env.MONGODB_URI), AsignaturasModule, ProfesoresModule, AlumnosModule, MaterialLabModule, MaterialInventarioModule, AditivosModule, EquiposTallerModule, EquiposLabModule, PracticasModule],
  controllers: [],
